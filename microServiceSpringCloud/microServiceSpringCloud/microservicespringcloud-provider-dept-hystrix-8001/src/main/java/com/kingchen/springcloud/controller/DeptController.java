...
//    }
    ...
    public DeptDTO get(@PathVariable("id") Long id)
    {
        ...
        DeptDTO dept = this.deptService.get(id);
    ...
    public DeptDTO processHystrix_Get(@PathVariable("id") Long id)
    {
        DeptDTO deptDTO = new DeptDTO();
        deptDTO.setId(Math.toIntExact(id));
        deptDTO.setDeptName("该ID：" + id + "没有没有对应的信息,null--@HystrixCommand-kingchen");
        return deptDTO;
    }
